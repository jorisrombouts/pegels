...
function tx(overrides: Partial<Transaction>): Transaction {
  return {
    ...
    categoryConfidence: null, categoryLevel: null,
...
describe("effectiveExpense", () => {
  ...
  it("counts only expense-kind transactions", () => {
    const base = { id: "t", date: "2025-03-01", description: "x", accountId: "a", categoryId: null, predictedCategoryId: null, categoryConfidence: null, categoryLevel: null, categorySource: "user" as const, needsReview: false, tagIds: [] };
  ...
  it("counts only the mine portion of a split expense", () => {
    const base = { id: "t", date: "2025-03-01", description: "x", accountId: "a", categoryId: null, predictedCategoryId: null, categoryConfidence: null, categoryLevel: null, categorySource: "user" as const, needsReview: false, tagIds: [], kind: "expense" as const };
