...
export const accounts: Account[] = [
  ...
  { id: "acc-spar", name: "SEB Savings", type: "Savings", kind: "savings", icon: "🐷", color: "150 60% 48%", balance: 50000, archived: false },
...
export const categories: Category[] = [
  ...
  { id: "cat-alcohol", name: "Alcohol", icon: "🍷", color: "120 48% 44%", parentId: "cat-food" },
  { id: "cat-cafe", name: "Café & Fika", icon: "☕", color: "30 50% 48%", parentId: "cat-food" },
  ...
  { id: "cat-mortgage", name: "Mortgage", icon: "🏦", color: "208 80% 56%", parentId: "cat-housing" },
  ...
  { id: "cat-purchases", name: "Purchases", icon: "🏬", color: "318 70% 60%", parentId: null },
  { id: "cat-clothing", name: "Clothing", icon: "👕", color: "330 76% 62%", parentId: "cat-purchases" },
  { id: "cat-electronics", name: "Electronics", icon: "💻", color: "300 55% 58%", parentId: "cat-purchases" },
  { id: "cat-shopping", name: "Shopping", icon: "🛍️", color: "350 78% 64%", parentId: "cat-purchases" },
  { id: "cat-home", name: "Home & Furniture", icon: "🛋️", color: "25 55% 55%", parentId: "cat-purchases" },
  { id: "cat-hobbies", name: "Hobbies & Leisure", icon: "🎨", color: "291 64% 62%", parentId: "cat-purchases" },
...
export const transactions: Transaction[] = [
  ...
  t("2025-03-14", "Överföring till Sparkonto", -5000, null, { categoryConfidence: null, categorySource: "user", kind: "transfer" }),
  t("2025-03-14", "Överföring från Lönekonto", 5000, null, { accountId: "acc-spar", categoryConfidence: null, categorySource: "user", kind: "transfer" }),
